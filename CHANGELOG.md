...
- Multi-line formatting toggles (blockquote, block code, bullet/numbered/task list) no longer rewrite CRLF line endings to LF — the replaced lines now keep the document's line endings ([#120](https://github.com/dvlprlife/Markdown-Foundry/issues/120)).
